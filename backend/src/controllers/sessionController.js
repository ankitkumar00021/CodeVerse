...
export async function createSession(req, res) {
  try {
    console.log("CreateSession - req.user:", req.user ? "exists" : "NOT FOUND");
    ...
    try {
      ...
      console.error("Stream Video Error:", streamError.message);
      // Don't fail if stream video fails, session is still created
    }
    ...
    try {
      ...
      console.error("Stream Chat Error:", chatError.message);
      // Don't fail if chat creation fails, session is still created
    }
